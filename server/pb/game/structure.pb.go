...
func (x *KeyInput) Reset() {
	*x = KeyInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_game_structure_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeyInput) Descriptor() ([]byte, []int) {
	return file_proto_game_structure_proto_rawDescGZIP(), []int{3}
}

func (x *KeyInput) GetX() float32 {
	if x != nil {
		return x.X
	}
	return 0
...
func (x *MatchAccountInfo) Reset() {
	*x = MatchAccountInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_game_structure_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MatchAccountInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MatchAccountInfo) ProtoMessage() {}

func (x *MatchAccountInfo) ProtoReflect() protoreflect.Message {
	mi := &file_proto_game_structure_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MatchAccountInfo.ProtoReflect.Descriptor instead.
func (*MatchAccountInfo) Descriptor() ([]byte, []int) {
	return file_proto_game_structure_proto_rawDescGZIP(), []int{4}
}

func (x *MatchAccountInfo) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *MatchAccountInfo) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
var file_proto_game_structure_proto_rawDesc = []byte{
	...
	0x08, 0x56, 0x65, 0x6c, 0x6f, 0x63, 0x69, 0x74, 0x79, 0x12, 0x0c, 0x0a, 0x01, 0x78, 0x18, 0x01,
	...
	0x52, 0x01, 0x7a, 0x22, 0x26, 0x0a, 0x08, 0x4b, 0x65, 0x79, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12,
	0x0c, 0x0a, 0x01, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01, 0x78, 0x12, 0x0c, 0x0a,
	0x01, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01, 0x79, 0x22, 0x3a, 0x0a, 0x10, 0x4d,
	0x61, 0x74, 0x63, 0x68, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12,
	0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x42, 0x49, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x62, 0x6f, 0x6d, 0x62, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x67, 0x61, 0x6d, 0x65, 0xaa, 0x02, 0x0a, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47, 0x61,
...
var file_proto_game_structure_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_game_structure_proto_goTypes = []interface{}{
	(*Position)(nil),         // 0: proto.Position
	(*Rotation)(nil),         // 1: proto.Rotation
	(*Velocity)(nil),         // 2: proto.Velocity
	(*KeyInput)(nil),         // 3: proto.KeyInput
	(*MatchAccountInfo)(nil), // 4: proto.MatchAccountInfo
}
...
func file_proto_game_structure_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_game_structure_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_game_structure_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MatchAccountInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
